...
export class GanttSingleView extends SingleViewBase {
  ...
  getHeaderCover(_rowId: string): GanttColumn | undefined {
  ...
  getHeaderIcon(_rowId: string): GanttColumn | undefined {
  ...
  getHeaderTitle(_rowId: string): GanttColumn | undefined {
  ...
  propertyGet(columnId: string): GanttColumn {
    return new GanttColumn(this, columnId);
  }
